...
4.Load Firmware to NIC:
	cd /home/ovs1/xiaochen/workspace/ovs/
	sudo /home/ovs1/xiaochen/nfp-sdk-6.0.2/p4/bin/rtecli -n design-load -f ovs.nffw -p out/pif_design.json
...
6.Load Static Rules to NIC(Don't edit user_config.json, copy it and modify the copy):
	sudo /home/ovs1/xiaochen/nfp-sdk-6.0.2/p4/bin/rtecli -n config-reload -c user_config.json
...
11. Unload Firmware from NIC:
	sudo /home/ovs1/xiaochen/nfp-sdk-6.0.2/p4/bin/rtecli -n design-unload
